...
console.log(splitMe("ciao mi chiamo carannante luigi"));
...
console.log(onlyLetters("7l47u78i37g487426i84o47k44"));
...
console.log(isThisAnEmail("luigicarannante9802@libero.it"));

/*if (isThisAnEmail() == true) {
  console.log("l'indirizzo è valido");
} else {
...
function rollTheDices(numero) {
  ...
  for (let i = 0; i < numero; i++) {
    let value = dice();
    risultato.valore.push(value);
    risultato.somma += value;
  }
  return risultato;
}
let rolls = rollTheDices(10);
console.log(rolls.valore);
console.log("La somma è:" + rolls.somma);
...
function howManyDays(date) {
  ...
  let valuepass = new Date(date);
  let differenceInMilliseconds = currentDate - valuepass;
...
console.log(howManyDays("1998/02/27"));
...
console.log(" L'Oggetto dopo la rimozione della proprietà  'age' è :", updatedObject);
...
function newestMovie(movies) {
  return movies.reduce((Recentfilm, currentMovie) => {
    return parseInt(currentMovie.Year) > parseInt(Recentfilm.Year) ? currentMovie : Recentfilm;
  });
}
...
//Risultato dell'esercizio 12
const Recentfilm = newestMovie(movies);
console.log("Il film più recente è:", Recentfilm);
// Risultato dell'esercizio 13
console.log("il numero dei film è:", countMovies(movies));
//Risultato dell'esercizio 14
const years = onlyTheYears(movies);
console.log("Gli anni di uscita dei film sono:", years);
//Risultato esercizio 15
const moviesInLastMillennium = onlyInLastMillennium(movies);
console.log("Film prodotti nel millennio scorso sono :", moviesInLastMillennium);
